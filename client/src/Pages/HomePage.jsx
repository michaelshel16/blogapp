   ...
   const fetchData = async()=>{
    ...
    try 
    {
      const resArr = await axios.all(
        [axios.get("https://blogapp-server-gamma.vercel.app/blog/v1/posts/tech"),
        axios.get("https://blogapp-server-gamma.vercel.app/blog/v1/posts/business"),
        axios.get("https://blogapp-server-gamma.vercel.app/blog/v1/posts/reviews")])
        ...
        <div className='home-container'>
             ...
             <div className='home-page-post'>
               <div className='home-page-post-image'>
                  <img src={`https://blogapp-server-gamma.vercel.app/assets/${HeaderPost.image}`}
