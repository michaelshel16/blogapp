...
const RegisterPage = () => {
    ...
    {  
      ...
      axios.post("https://blog-full-stack-ndnl.onrender.com/blog/v1/register",values )
      .then((res)=>
      {
        console.log(res);
      })
   ...
   const googleSubmit = () =>
   {
       ...
       { console.log(result.user)
        ...
        if(user)
        {
        axios.post("https://blog-full-stack-ndnl.onrender.com/blog/v1/googleRegister", user)
        .then((res)=>
        {
        if(res.status == 401)
        {
